...
class DataPenyakitSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    Penyakit::create([
      ...
      'srn_penyakit' => 'Pengendalian Hayati: Larutan berbasis bakteri Pseudomonas fluorescens dapat digunakan
    ...
    Penyakit::create([
      ...
      'srn_penyakit' => 'Pengendalian Kimiawi: Selalu pertimbangkan pendekatan terpadu dengan tindakan pencegahan
