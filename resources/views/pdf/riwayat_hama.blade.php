...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ public_path('mazer/css/bootstrap.css') }}">
</head>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-5">
                        <div class="alert alert-success">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <p>Berdasarkan dari gejala yang kamu pilih atau alami juga berdasarkan Role/Basis
                                        aturan
                                        yang
                                        sudah ditentukan oleh seorang pakar penyakit maka perhitungan Algoritma
                                        Certainty
                                        Factor
                                ...
                                <div class="col-md-6">
                                    <img src="{{ url('images/hama/', unserialize($riwayat->cf_max)[2]) }}"
