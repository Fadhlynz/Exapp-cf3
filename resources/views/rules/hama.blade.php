    ...
    @foreach ($ruleshama as $data1)
        <script>
            ...
            function updateRange() {
                ro_{{ $data1->id }}.textContent = myRange_{{ $data1->id }}[parseInt(rng_{{ $data1->id }}.value, 10)]
                    .toFixed(2) * 100 + '%';
                in_val_evidence_{{ $data1->id }}.value = myRange_{{ $data1->id }}[parseInt(rng_{{ $data1->id }}
                    .value, 10)].toFixed(2);
            };
