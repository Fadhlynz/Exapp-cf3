        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Riwayat Diagnosa Penyakit</h4>
                </div>
                <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="data-tab" data-bs-toggle="tab" href="#data" role="tab"
                                aria-controls="data" aria-selected="false">Hasil Diagnosa Penyakit</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="graph-tab" data-bs-toggle="tab" href="#graph" role="tab"
                                aria-controls="graph" aria-selected="true">Graph Hasil Diagnosa Penyakit</a>
                        </li>
                    </ul>
        ...
        var myBar = new Chart(ctxBar, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [
                        @foreach ($hypotesis as $hypo)
                            {{ $history->where('penyakit_id', $hypo->id)->count() }},
                        @endforeach
                    ]
                }]
            },
