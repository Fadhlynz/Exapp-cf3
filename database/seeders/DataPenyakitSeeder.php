...
class DataPenyakitSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    Penyakit::create([
      ...
      'srn_penyakit' => '<p>Pengendalian Hayati: Larutan berbasis bakteri Pseudomonas fluorescens dapat digunakan
          sebagai perlakuan benih dan sebagai semprotan untuk mengurangi timbulnya penyakit, dan produksi racun.</p>
        <p>Pengendalian Kimiawi: Selalu pertimbangkan pendekatan terpadu berupa tindakan pencegahan bersama dengan
        ...
        propikonazol 1 ml / I dapat digunakan pada tahap pengerasan biji untuk mengendalikan jamur.</p>',
    ...
    Penyakit::create([
      ...
      'srn_penyakit' => '<p>Pengendalian Kimiawi: Selalu pertimbangkan pendekatan terpadu dengan tindakan pencegahan
            bersama dengan perlakuan hayati jika tersedia. Penyemprotan fungisida dapat bermanfaat jika digunakan pada
            ...
            dalam selang 10 hari hingga tahap berbunga.</p>',
    ...
    Penyakit::create([
      ...
      'srn_penyakit' => '<p>1. Mencabut tanaman yang terinfeksi seawal mungkin agar tidak menjadi sumber infeksi bagi
          tanaman sekitarnya ataupun pertanaman yang akan datang.</p><p>2. Mengadakan pergiliran tanaman, tidak menanam
      jagung terus menerus di lahan yang sama.</p><p>3. Penggunaan peptisida apabila di lapangan populasi vektor cukup
      tinggi.</p>
      <p>4. Tidak penggunakan benih yang berasal dari tanaman yang terinfeksi.</p>',
